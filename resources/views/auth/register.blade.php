            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="qualification" type="text" class="form-control" name="qualification" required autocomplete="qualification">
                                </div>
                        </div>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="subject" type="text" class="form-control" name="subject" required autocomplete="subject">
                                </div>
                        </div>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_no" type="number" class="form-control" name="phone_no" required autocomplete="phone_no">
                                </div>
                        </div>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="parent_email" type="email" class="form-control" name="parent_email" required autocomplete="parent_email">
                                </div>
                        </div>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="standard" type="number" class="form-control" name="standard" required autocomplete="standard">
                                </div>
                        </div>
